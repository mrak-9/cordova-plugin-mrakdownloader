...
var MrakDownload = require('../www/MrakDownload'); //module under test
...
describe('MrakDownload module', function () {

    describe('MrakDownload constructor', function () {
        it('should export a function', function () {
            expect(MrakDownload).to.be.a('function');
        });
    });

    describe('MrakDownload.Initialize', function () {
        it('should export a function', function () {
    ...
    describe('MrakDownload.Get', function () {
